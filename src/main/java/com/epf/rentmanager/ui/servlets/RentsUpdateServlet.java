    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            try {
                ...
                String debut = reservationService.findResaById(id).getDebut().format(formatter);
                String fin = reservationService.findResaById(id).getFin().format(formatter);
                request.setAttribute("begin", debut);
